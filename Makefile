...
# Generated by qmake (2.01a) (Qt 4.8.7) on: jeu. nov. 30 14:19:56 2017
# Project:  main.pro
# Template: app
...
SOURCES       = curve1DBezierParam.cpp \
		curve1DBezier.cpp \
		main.cpp \
		mainWidget.cpp \
		toolsWidget.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/yourAppName1.0.0/ && $(COPY_FILE) --parents mainWidget.h toolsWidget.h drawingWidgetItems.h drawingWidget.h animationWidgetItems.h animationWidget.h scene.h curve1D.h curve2D.h curve1DLinear.h curve1DBezierParam.h curve1DBezier.h curve2DLinear.h curve2DBezierBasic.h curve2DBezier.h animatedPoint.h .tmp/yourAppName1.0.0/ && $(COPY_FILE) --parents curve1DBezierParam.cpp curve1DBezier.cpp main.cpp mainWidget.cpp toolsWidget.cpp drawingWidgetItems.cpp drawingWidget.cpp animationWidgetItems.cpp animationWidget.cpp scene.cpp animatedPoint.cpp .tmp/yourAppName1.0.0/ && (cd `dirname .tmp/yourAppName1.0.0` && $(TAR) yourAppName1.0.0.tar yourAppName1.0.0 && $(COMPRESS) yourAppName1.0.0.tar) && $(MOVE) `dirname .tmp/yourAppName1.0.0`/yourAppName1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/yourAppName1.0.0
...
curve1DBezierParam.o: curve1DBezierParam.cpp curve1DBezierParam.h \
		curve1D.h \
		scene.h \
		curve2D.h \
		animatedPoint.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o curve1DBezierParam.o curve1DBezierParam.cpp

curve1DBezier.o: curve1DBezier.cpp curve1DBezier.h \
		curve1D.h \
		scene.h \
		curve2D.h \
		animatedPoint.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o curve1DBezier.o curve1DBezier.cpp
